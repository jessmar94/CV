...
| [Bowling Scorecard](https://github.com/jessmar94/bowling-challenge)  | Individual project | JavaScript, Jasmine | Four days | This project was a challenge to produce a bowling scorecard. It was a good opportunity to learn how to implement ESLint and run both the tests and the program from the terminal using node, as previously we'd only done this in the browser.| 
...
#### Makers Academy (August 2019 - December 2019) 
